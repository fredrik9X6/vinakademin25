...
# Pass NEXT_PUBLIC_* env vars for client-side build
...
# Cron scripts: source files, config, and full node_modules needed
# when this image is reused by a Railway Cron service.
# The cron start command overrides CMD to run tsx directly.
