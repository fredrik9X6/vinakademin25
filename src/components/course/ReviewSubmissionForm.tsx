    ...
    return (
      <Card className="text-center py-12">
        <CardContent className="space-y-4">
          ...
          <Link href={`/vinkvallen/${courseSlug}`}>
    ...
    return (
      <Card className="text-center py-12">
        <CardContent className="space-y-4">
          ...
          <Link href={`/logga-in?from=${encodeURIComponent(`/vinkvallen/${courseSlug}/recension${token ? `?token=${token}` : ''}`)}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Berätta om din upplevelse av vinkursen..."
              rows={5}
              maxLength={2000}
