...
export interface Config {
  ...
  collections: {
    ...
    wines: Wine;
    'user-wines': UserWine;
    'systembolaget-products': SystembolagetProduct;
  ...
  collectionsSelect: {
    ...
    'systembolaget-products': SystembolagetProductsSelect<false> | SystembolagetProductsSelect<true>;
 ...
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "systembolaget-products".
 */
export interface SystembolagetProduct {
  id: number;
  /**
   * Systembolaget's stable product number (e.g. '7355')
   */
  productNumber: string;
  productNumberShort?: string | null;
  /**
  ...
  /**
   * Top-level category (e.g. 'Rött vin', 'Vitt vin')
   */
  ...
  /**
   * Country string from upstream (e.g. 'Frankrike')
   */
  country?: string | null;
  ...
  isCompletelyOutOfStock?: boolean | null;
  isTemporaryOutOfStock?: boolean | null;
  isNews?: boolean | null;
  isOrganic?: boolean | null;
  isKosher?: boolean | null;
  isEthical?: boolean | null;
  ethicalLabel?: string | null;
  isSustainableChoice?: boolean | null;
  isClimateSmartPackaging?: boolean | null;
  /**
   * Bottle image URL on Systembolaget CDN
   */
  imageUrl?: string | null;
  /**
   * systembolaget.se product page URL
   */
  ...
  /**
   * Grape strings from Systembolaget (array of strings).
   */
  grapes?:
    | {
        [k: string]: unknown;
  ...
  raw?:
    ...
    | null;
  /**
   * When this row was last touched by the importer.
   */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        ...
        value: number | SystembolagetProduct;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "systembolaget-products_select".
 */
export interface SystembolagetProductsSelect<T extends boolean = true> {
  productNumber?: T;
  productNumberShort?: T;
  productNameBold?: T;
  productNameThin?: T;
  producerName?: T;
  supplierName?: T;
  ...
  assortmentText?: T;
  isDiscontinued?: T;
  isCompletelyOutOfStock?: T;
  isTemporaryOutOfStock?: T;
  isNews?: T;
  isOrganic?: T;
  isKosher?: T;
  isEthical?: T;
  ethicalLabel?: T;
  isSustainableChoice?: T;
  isClimateSmartPackaging?: T;
  imageUrl?: T;
  productUrl?: T;
  searchTitle?: T;
  grapes?: T;
